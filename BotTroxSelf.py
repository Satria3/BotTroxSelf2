...
cl.login(token="ExDwirQrE087TzJRqJS0.fGIUiExEjuE1/OChSHYIia.6llQLM9KHaPytOKaqIhE442M2v+Z219CdPNCA9jLMxc=")
cl.loginResult()

ki = LIBETCR.LINE()
ki.login(token="ExDwirQrE087TzJRqJS0.fGIUiExEjuE1/OChSHYIia.6llQLM9KHaPytOKaqIhE442M2v+Z219CdPNCA9jLMxc=")
ki.loginResult()

ki2 = LIBETCR.LINE()
ki2.login(token="ExDwirQrE087TzJRqJS0.fGIUiExEjuE1/OChSHYIia.6llQLM9KHaPytOKaqIhE442M2v+Z219CdPNCA9jLMxc=")
ki2.loginResult()
