...
#------------------------End---------------------
 ...
 #-----------------End-----------
              ...
              if msg.from_ in admin:
                ...
                ki2.sendText(msg.to,"Hi BotTrox 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"BotTrox on")
                ki.sendText(msg.to,"BotTrox1 on")
                ki2.sendText(msg.to,"BotTrox2 On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u1608ae21e5de2547b5fa8707b21ca220'}
              cl.sendText(msg.to,"🇲🇨PERKENALKAN🇲🇨")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"🇲🇨JANGAN KAGET EA")
              cl.sendText(msg.to,"Itu Creator Kami yang vekok😂")
